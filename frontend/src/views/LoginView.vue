<template>
    <div class="pt-16">
        <form v-if="!waitingOnVerification" action="#" @submit.prevent="handleLogin">
            ...
            <div class="overflow-hidden shadow sm:rounded-md max-w-sm mx-auto text-left">
                <div class="bg-white px-4 py-5 sm:p-6">
                    <div>
                        <input type="text" v-maska data-maska="+### ## ###-###" v-model="credentials.phone" name="phone" id="phone" placeholder="+387 63 123-456" class="mt-1 block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:border-black focus:outline-none">
                    </div>
                </div>
        ...
        <form v-else action="#" @submit.prevent="handleVerification">
            <h1 class="text-3xl font-semibold mb-4">Enter your login code from SMS</h1>
            <div class="overflow-hidden shadow sm:rounded-md max-w-sm mx-auto text-left">
                <div class="bg-white px-4 py-5 sm:p-6">
                    <div>
